package com.cotato.itda.domain.challenge.exception.code;
...
public enum ChallengeErrorCode implements ErrorCode {
    ...
    LIKE_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 좋아요 누른 챌린지입니다.", "CHALLENGE_ERROR_409_LIKE_ALREADY_EXISTS"),
